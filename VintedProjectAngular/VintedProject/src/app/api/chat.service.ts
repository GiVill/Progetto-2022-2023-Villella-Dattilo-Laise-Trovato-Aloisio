...
export class ChatService {
     ...
     */
    public allChatUser(id: number, observe?: 'body', reportProgress?: boolean): Observable<Array<ChatDto>>;
    public allChatUser(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ChatDto>>>;
    public allChatUser(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ChatDto>>>;
    public allChatUser(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
      ...
      if (this.CookiesService.getTokent()) {
        ...
        return this.httpClient.request<Array<ChatDto>>('get',`${this.basePath}/v1/chat/user/${encodeURIComponent(String(id))}`,
            {
