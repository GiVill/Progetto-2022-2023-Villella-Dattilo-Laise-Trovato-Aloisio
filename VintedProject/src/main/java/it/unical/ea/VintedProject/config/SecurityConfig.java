...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers(HttpMethod.GET,"/v1/users/{idUser}").hasAnyRole(USER,ADMIN)
                ...
                .requestMatchers(HttpMethod.POST, "/v1/admin/users").hasAnyRole(USER,ADMIN)
                ...
                //INSERTION
                .requestMatchers(HttpMethod.GET, "/v1/insertions").hasRole(USER)
                .requestMatchers(HttpMethod.GET, "/v1/insertions/{insertionId}").hasAnyRole(USER,ADMIN)
                .requestMatchers(HttpMethod.GET, "/v1//insertions/order/{orderId}").hasAnyRole(USER,ADMIN)
                .requestMatchers(HttpMethod.GET, "/v1/insertions/{idUser}/{page}").hasAnyRole(ADMIN,USER)
                .requestMatchers(HttpMethod.GET, "/v1/myInsertions/{page}").hasAnyRole(ADMIN,USER)
                .requestMatchers(HttpMethod.GET, "/v1/insertions/title/{title}/{page}").hasAnyRole(ADMIN,USER)
                .requestMatchers(HttpMethod.GET, "/v1/insertions/brand/{brand}/{page}").hasAnyRole(ADMIN,USER)
                .requestMatchers(HttpMethod.GET, "/v1/insertions/category/{category}/{page}").hasAnyRole(ADMIN,USER)
                ...
                .requestMatchers(HttpMethod.POST, "/v1/insertions").hasAnyRole(USER,ADMIN)
                ...
                //IMAGE
                .requestMatchers(HttpMethod.GET, "/v1/images/{imagePath}").hasAnyRole(USER,ADMIN)
