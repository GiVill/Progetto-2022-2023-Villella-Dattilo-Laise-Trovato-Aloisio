...
@Database(entities = [UserDatabaseDto::class, CartDto::class], version = 2, exportSchema = false) //Il valore di version deve essere equivalente (o superiore di 1) al numero di entities inserite
